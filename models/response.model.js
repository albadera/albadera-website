...
class ResponseModel {
    ...
    static success(message, data = {}, noMoreOfResult = null) {
        return new ResponseModel(response_type_enum_1.ResponseTypeEnum.success, message, true, data, null, noMoreOfResult);
    }
